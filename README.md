...
## About
Car rental application in a distributed rental agency system that allows to plan trips (i.e. make reservations at several rental companies). The system allow multiple users to book concurrently in a safe way using Java RMI. (see full [project](https://github.com/matt77hias/meta-carrental))
